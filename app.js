	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'font-family', 'Roboto Mono, monospace')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'color', 'rgb(0, 183, 235)'),
						A2($elm$html$Html$Attributes$style, 'font-size', '20vh')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'margin', '0'),
						A2($elm$html$Html$Attributes$style, 'color', 'rgb(0, 183, 235)'),
						A2($elm$html$Html$Attributes$style, 'font-size', '15vh')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$width('90vw'),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$svg$Svg$Attributes$fill('rgba(0, 183, 235, 0.1)'),
								$elm$svg$Svg$Attributes$stroke('rgb(0, 183, 235)'),
								$elm$svg$Svg$Attributes$strokeDasharray('6'),
